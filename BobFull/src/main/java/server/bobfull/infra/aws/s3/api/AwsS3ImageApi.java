package server.bobfull.infra.aws.s3.api;
...
import server.bobfull.infra.aws.s3.dto.AwsS3ImageDtos.ImageDto;
import server.bobfull.infra.aws.s3.dto.AwsS3ImageDtos.ImagesResponseDto;
import server.bobfull.infra.aws.s3.service.AwsS3ImageService;
